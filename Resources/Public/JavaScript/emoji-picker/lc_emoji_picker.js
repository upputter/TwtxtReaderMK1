...
(function() { 
    ...
    window.lc_emoji_picker = function(attachTo, options = {}) {
        ...
        this.show_picker = function(trigger) {
            ...
            const y_pos_css = 'top: ' + (document.getElementById('emojiCMDButton').offsetTop + document.getElementById('emojiCMDButton').offsetHeight);
            // const y_pos_css = document.getElementById('emojiCMDButton').offset;
           console.log(y_pos_css);
        ...
        this.wrap_element = function(el) {
            ...
            div.innerHTML = 
                '<span class="lcep-trigger" id="emojiTrigger" style="'+ trigger_css +'" title="'+ options.labels[0] +'">'+ 
        ...
        this.append_emoji_picker = function() {
            ...
            document.getElementById('modal-form').insertAdjacentHTML('beforeend', picker);
...
.lcep-grid > li:hover {
    background: var(--pico-primary-hover-underline);
}
...
.lcep-categories li.lcep-active {
    box-shadow: 0 -3px 0 var(--pico-primary-hover-underline) inset;
}
.lcep-categories a {
